...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!['TREE_PLANTATION', 'CLEANUP', 'SOLAR_INSTALLATION', 'PLASTIC_COLLECTION', 'WASTE_REDUCTION', 'WATER_CONSERVATION', 'RENEWABLE_ENERGY', 'SUSTAINABLE_TRANSPORT', 'EDUCATION_OUTREACH', 'OTHER'].includes(actionType)) {
      return NextResponse.json(
